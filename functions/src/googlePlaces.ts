...
const GOOGLE_PLACES_API_KEY = "AIzaSyBcbPPKcV9b0Nbu7WQ7uj-Suce-WILi_24";
 ...
 */
export const searchAddresses = onCall({region: "europe-west1"}, async (request) => {
 ...
 */
export const getPlaceDetails = onCall({region: "europe-west1"}, async (request) => {
  // Verificar autenticació
  if (!request.auth) {
    throw new HttpsError(
      "unauthenticated",
